...
<!--
  Three fields, because that is all the floor needs: the picture to recognise
  it by, the code to quote it by, and the name. Price and specification live on
  the main website, and two places holding the same price is one place holding
  the wrong one.
-->
<template>
    <Head :title="heading" />
    ...
    <div class="flex flex-col gap-5">
        ...
        >
            ...
            be overwritten the next time the catalogue is synced.
        </div>
